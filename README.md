...
| Công nghệ | Mục đích |
|-----------|----------|
| **HTML5 / CSS3** | Cấu trúc và giao diện trang web |
| **JavaScript** | Tương tác động (popup, tabs, language switch, counter animation) |
...
- Trang web hỗ trợ **đa ngôn ngữ** (Tiếng Việt / Tiếng Anh) - chuyển đổi bằng nút `🌐` trên thanh điều hướng
- Tự động chuyển đổi **theme sáng/tối**
